...
/* harmony import */ var _diffDates_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./diffDates.js */ "./js/diffDates.js");
...
function handleCalcDates(event){
	...
	if(firstDate && secondDate) {
		const result = (0,_diffDates_js__WEBPACK_IMPORTED_MODULE_1__.diffDates)(firstDate, secondDate);
		dateCalcResult.innerHTML = (0,_diffDates_js__WEBPACK_IMPORTED_MODULE_1__.diffToHTML)(result);
	} else dateCalcResult.innerHTML = (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.formatError)("Для расчета промежутка необходимо заполнить оба поля!");
 }; 
...
/* harmony export */ });
/* harmony import */ var _luxon_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./luxon.js */ "./js/luxon.js");
...
/* harmony export */   "LocalZone": () => (/* binding */ LocalZone),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_exp); 
...
function startTimer() {
	if (minutesEl.value == 0 && secondsEl.value == 0) {
		timer__err.innerHTML = (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.formatError)("Веедите требуемое время.")
		...
		timerId = setInterval(function () {
			if (minutesEl.value == 0 && secondsEl.value == 0) {
				...
				timer__err.innerHTML = (0,_common_js__WEBPACK_IMPORTED_MODULE_0__.formatError)("Время закончилось!")
...
/* harmony import */ var _switcher_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./switcher.js */ "./js/switcher.js");
/* harmony import */ var _switcher_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_switcher_js__WEBPACK_IMPORTED_MODULE_2__);



// import "../style.css";
// import css from "../style.css"; !!! НЕ ВИДИТ ФАЙЛЫ CSS И SCSS !!!
